...
public class TransactionsController{
    ...
    public static List selectAll(){
        try{
            PreparedStatement ps = main.db.prepareStatement("SELECT TransactionID, AccountID, BalanceChange, CategoryID, Description, Date, StandingOrderID FROM Transactions");
    ...
    public static List search(int searchID){
        try {
            PreparedStatement ps = main.db.prepareStatement("SELECT TransactionID, AccountID, BalanceChange, CategoryID, Description, Date, StandingOrderID FROM Transactions WHERE TransactionID = ?");
